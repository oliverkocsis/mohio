...
const mohioApi = createMohioApi({
  ...
  createCheckpoint: (input) => ipcRenderer.invoke(MOHIO_CHANNELS.createCheckpoint, input),
  createAiChangeCheckpoint: (relativePath, reason) =>
    ipcRenderer.invoke(MOHIO_CHANNELS.createAiChangeCheckpoint, relativePath, reason),
  listCheckpoints: (relativePath) => ipcRenderer.invoke(MOHIO_CHANNELS.listCheckpoints, relativePath),
  ...
  getCheckpointDiff: (input) => ipcRenderer.invoke(MOHIO_CHANNELS.getCheckpointDiff, input),
  revertToCheckpoint: (input) => ipcRenderer.invoke(MOHIO_CHANNELS.revertToCheckpoint, input),
